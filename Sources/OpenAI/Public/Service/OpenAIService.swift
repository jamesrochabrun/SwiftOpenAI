...
public enum APIError: Error {
    ...
    public var displayDescription: String {
        switch self {
        case let .requestFailed(description): description
        case let .responseUnsuccessful(description, _): description
        case .invalidData: "Invalid data"
        case let .jsonDecodingFailure(description): description
        case let .dataCouldNotBeReadMissingData(description): description
