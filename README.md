...
An open-source Swift package designed for effortless interaction with OpenAI's public API. Now also available as [CLI](https://github.com/jamesrochabrun/SwiftOpenAICLI) 
