...
final class OutputItemTests: XCTestCase {
    ...
    func testOutputItemFileSearchCall() throws {
        ...
        if case let .fileSearchCall(fileSearch) = outputItem {
    ...
    func testOutputItemFunctionCall() throws {
        ...
        if case let .functionCall(functionCall) = outputItem {
    ...
    func testOutputItemWebSearchCall() throws {
        ...
        if case let .webSearchCall(webSearch) = outputItem {
    ...
    func testOutputItemComputerCall() throws {
        ...
        if case let .computerCall(computerCall) = outputItem {
    ...
    func testOutputItemReasoning() throws {
        ...
        if case let .reasoning(reasoning) = outputItem {
    ...
    func testOutputItemImageGenerationCall() throws {
        ...
        if case let .imageGenerationCall(imageGen) = outputItem {
    ...
    func testOutputItemCodeInterpreterCall() throws {
        ...
        if case let .codeInterpreterCall(codeInterpreter) = outputItem {
            ...
            if case let .log(logOutput) = codeInterpreter.outputs?[0] {
    ...
    func testCodeInterpreterImageOutput() throws {
        ...
        if case let .codeInterpreterCall(codeInterpreter) = outputItem {
            ...
            if case let .image(imageOutput) = codeInterpreter.outputs?[0] {
    ...
    func testOutputItemLocalShellCall() throws {
        ...
        if case let .localShellCall(localShell) = outputItem {
    ...
    func testOutputItemMCPCall() throws {
        ...
        if case let .mcpCall(mcpCall) = outputItem {
    ...
    func testOutputItemMCPListTools() throws {
        ...
        if case let .mcpListTools(mcpListTools) = outputItem {
    ...
    func testOutputItemMCPApprovalRequest() throws {
        ...
        if case let .mcpApprovalRequest(approval) = outputItem {
