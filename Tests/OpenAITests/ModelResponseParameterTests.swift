...
final class ModelResponseParameterTests: XCTestCase {
    ...
    func testModelResponseParameterDecoding() throws {
        ...
        if case let .string(text) = parameter.input {
    ...
    func testModelResponseParameterDecodingWithArrayInput() throws {
        ...
        if case let .array(items) = parameter.input {
            ...
            if case let .message(userMsg) = items[1] {
                ...
                if case let .array(contentItems) = userMsg.content {
